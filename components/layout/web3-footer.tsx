...
export function Web3Footer() {
  ...
  const copyrightName = "Dude dot box LLC.";

  return (
    <footer className="text-sm text-neutral-500 bg-gray-900">
      <div className="border-t border-neutral-800 py-6 text-sm">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-1 px-4 md:flex-row md:items-center md:justify-center md:gap-4 md:px-4 min-[1320px]:px-0">
          ...
          <hr className="mx-2 hidden h-4 w-[1px] border-l border-neutral-700 md:inline-block" />

        ...
        <div className="container mx-auto">
          ...
          <div className="section-box p-8 rounded-md mb-8">
            <div className="max-w-4xl mx-auto">
              ...
              This blog is my space to think out loud — a place where I wrestle with ideas about society, faith, and the world we’re shaping together. Some posts are reflective, some are challenging, and some are just me trying to make sense of things. My goal isn’t to preach or to lecture, but to share thoughts that spark conversation, reflection, and maybe even a shift in perspective.
              </p>
            </div>
          </div>

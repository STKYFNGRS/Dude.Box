    ...
    <Layout>
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="max-w-2xl text-center">
          ...
          <p className="text-lg">
            To design quality, stylish clothing for men while raising awareness and generating support for mental health initiatives. At Dude, we aim to spark conversations, break down stigmas, and make meaningful contributions to the mental health community with every item we sell.
          </p>
        </div>

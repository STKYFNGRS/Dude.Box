    ...
    <Layout>
      <div className="flex flex-col items-center justify-center p-4">
        ...
        <div className="max-w-2xl text-center">
          ...
          <p className="text-lg mb-4">
            I know what it&apos;s like to feel like you&apos;re facing the world alone, with all its noise and chaos, and maybe that&apos;s why Dude isn&apos;t just another brand to me. It&apos;s a vehicle, a lifeline, a way to carve out a space for the real conversations men aren&apos;t having. Every sale, every piece we make, is a step toward something bigger: a place here in San Diego where men can walk in, breathe out, and shed the armor. An office for free counseling, one-on-one talks, group sessions, AA meetings, jobs, a change of clothes or a haircut, whatever it takes to help another guy keep going.
          </p>
          <p className="text-lg">

    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl mx-auto">
      ...
      <Card 
        className={`relative group transition-all cursor-pointer
          ${state.walletType === 'none' ? 'bg-gray-800/50 border-gray-700 hover:border-blue-500' : 
            state.walletType === 'smart' ? 'bg-blue-900/20 border-blue-500' : 'opacity-50 cursor-not-allowed bg-gray-800/20 border-gray-800'}
        `}
        onClick={() => state.walletType === 'none' && connectSmartWallet()}
      >
        <CardHeader>
      ...
      <Card 
        className={`relative group transition-all cursor-pointer
          ${state.walletType === 'none' ? 'bg-gray-800/50 border-gray-700 hover:border-orange-500' : 
            state.walletType === 'regular' ? 'bg-orange-900/20 border-orange-500' : 'opacity-50 cursor-not-allowed bg-gray-800/20 border-gray-800'}
        `}
        onClick={() => state.walletType === 'none' && connectRegularWallet()}
      >
        <CardHeader>
          <div className="flex items-center gap-3">

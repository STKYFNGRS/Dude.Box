      ...
      <main className="flex-grow flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <section id="about" className="relative z-10 flex flex-col items-center justify-center py-12 px-4">
          ...
          <p className="max-w-2xl text-center text-lg md:text-xl text-[#b0b0b0] mb-6 animate-fade-in">
            D.U.D.E. Box is a post-apocalyptic robot foundry, creative lab, and high-tech misfit collective. We design, print, and engineer quirky, collectible robots, smart lamps, and interactive tech—right from our underground lair. Our mission: <span className="text-accent">bring joy, weirdness, and STEM inspiration to the world</span>—one nuclear-powered bot at a time.
          </p>
      ...
      <footer className="bg-black text-gray-400 p-8 border-t border-gray-800 relative z-10">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-white">D.U.D.E. Box LLC</span>

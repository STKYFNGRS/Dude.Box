      ...
      <div className="min-h-screen bg-gradient-to-b from-black to-gray-900">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center px-4">
            ...
            {/* Mission Statement */}
            <div className="bg-gray-900 p-6 rounded-lg mb-12 border border-gray-700 shadow-lg">
            ...
            <div className="mb-12">
              ...
              <div className="text-lg text-gray-200">
                ...
                {/* Core Services */}
                <div className="bg-gray-900 p-6 rounded-lg mb-6 border border-gray-700 shadow-lg">
            ...
            <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 shadow-lg">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative w-full h-80 rounded-lg overflow-hidden shadow-lg border border-gray-800">
                  <Image
                    src="/family2.jpg"
            ...
            {/* Call to Action */}
            <div className="mt-6 mb-8 p-4 bg-blue-500/20 border border-blue-500/40 rounded-lg text-center">

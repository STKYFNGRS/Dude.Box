        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-16 -mt-20 relative z-30">
            ...
            {[
              {
                ...
                title: "Utility First",
                description: "Dude token serves as the foundation for community engagement, governance, and exclusive access within the Dude Dot Box ecosystem."
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Community Driven",
                description: "Token holders can participate in community decisions, product development, and future initiatives through our governance system."
              },
              {
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all duration-300">
                <h3 className="text-2xl font-semibold mb-6 text-blue-400">Community Access</h3>
              ...
              <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition-all duration-300">
                <h3 className="text-2xl font-semibold mb-6 text-blue-400">Governance Rights</h3>
                <ul className="space-y-4 text-gray-300">
                  {[
          ...
          <div className="mb-24">
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-semibold mb-6 text-blue-400">Initial Allocation</h3>
                  <ul className="space-y-4 text-gray-300">
                    {[
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-6 text-blue-400">Vesting Schedule</h3>
                  <ul className="space-y-4 text-gray-300">
                    {[
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 text-center max-w-3xl mx-auto">
            <p className="text-gray-300 mb-4">
              ...
              DUDE tokens are utility tokens intended for platform participation and governance.
            </p>
            <p className="text-gray-400">
              Always conduct your own research and consult with qualified professionals before making any decisions.
            </p>
          </div>
        </div>
        <Analytics />

...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="aspect-square rounded-lg border-2 border-border bg-background/40 mb-4 flex items-center justify-center overflow-hidden group-hover:border-accent transition-all duration-300">
